...
ActiveRecord::Schema.define(version: 20150620185721) do
  ...
  add_index "spree_addresses", ["skype"], name: "index_spree_addresses_on_skype", using: :btree
  ...
  add_index "spree_orders", ["skype"], name: "index_spree_orders_on_skype", using: :btree
  ...
  add_index "spree_users", ["skype"], name: "index_spree_users_on_skype", using: :btree
